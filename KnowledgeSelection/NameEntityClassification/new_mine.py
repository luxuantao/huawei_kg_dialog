...
def main():
    ...
    parser.add_argument('--train_file', type=str, default='KnowledgeSelection/data/new_classification_train.json')
    parser.add_argument('--dev_file', type=str, default='KnowledgeSelection/data/new_classification_valid.json')
