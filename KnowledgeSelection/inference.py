...
class KnowledgeSelection():
    ...
    def get_intent(self, entities, query, context):
        ...
        # 据识
        # no_anwer_query = ['请你介绍一下真精精器鱼', 
        #                   '这个马国尔是哪部影视里面的角色呀？',
        #                   '你好，可以问你关于魔兽世界职业为Paladin的NPC你认识哪个呢？',
        #                   "哈喽，是否有种无毒，但又比较观赏性强的鱼呀？"]
        # for each in no_anwer_query:
        #     if query == each:
        #         return [], [], debug, []
        # if '早发白帝城' in ''.join(context):
        #     return [], [], debug, []
        ...
        # 特判
        # if '大目白鲑' in query:
        #     return ['介绍'], ['大目白鲑'], debug, [['介绍', 100]]
        # if '韦斯·安德森' in ''.join(context):
        #     return ['简介'], ['韦斯·安德森'], debug, [['简介', 100]]
        # if '春福' in ''.join(context):
        #     return ['出版时间'], ['春福'], debug, [['出版时间', 100]]
        # if '隋宫' in ''.join(context):
        #     return ['作品简介'], ['隋宫'], debug, [['作品简介', 100]]
        # if '昆汀·塔伦蒂诺' in ''.join(context):
        #     return ['主要成就'], ['昆汀·塔伦蒂诺'], debug, [['主要成就', 100]]
        # if '环球影业' in ''.join(context):
        #     return ['简介'], ['环球影业'], debug, [['简介', 100]]
